    ...
    public static void main(String[] args) {
        ...
        while (!dakonBoard.isFinished()) {
            ...
            if(dakonBoard.turn==1){
                dakonBoard.getGUI().setTurnLabel("Giliran Player 1 (Human)");
                ...
                dakonBoard.getGUI().setTurnLabel("Giliran Player 2 (AI)");
        ...
        for(int i=0;i<8;i++){
            skor1+=dakonBoard.getBoard(i);
        }
        for(int i=8;i<16;i++){
            skor2+=dakonBoard.getBoard(i);
        }
        if(skor1>skor2){
            dakonBoard.getGUI().setResultLabel("Player 1 menang");
        } else if (skor2>skor1){
            dakonBoard.getGUI().setResultLabel("Player 2 menang");
        }
        else{
            dakonBoard.getGUI().setResultLabel("Seri");
        }
